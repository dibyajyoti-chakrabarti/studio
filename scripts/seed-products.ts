...
const products = [
  {
    ...
    description:
      'Standard deep groove ball bearing, double rubber sealed for protection against dust and moisture.',
    isActive: true,
    ...
    reviews: [
      {
        user: 'Aman S.',
        rating: 5,
        comment: 'High quality, fits perfectly in my motor.',
        date: '2024-03-01',
      },
    ],
  ...
  },
  {
    ...
    faqs: [
      {
        q: 'Can it handle axial loads?',
        a: 'Yes, it is designed for both radial and axial loads.',
      },
    ],
    reviews: [
  ...
  },
  {
    ...
    faqs: [{ q: 'Is it heat resistant?', a: 'Safe up to 120°C.' }],
    reviews: [],
  ...
  },
  {
    ...
    description:
      'Standard linear motion bearing for 8mm rods, used in 3D printers and CNC machines.',
    isActive: true,
    features: [
      'Smooth linear motion',
      'Compact design',
      'Compatible with 8mm rods',
    ...
    faqs: [
      {
        q: 'Is it compatible with 8mm smooth rods?',
        a: 'Yes, specifically designed for 8mm hardened smooth rods.',
      },
      {
        q: 'Should I lubricate it?',
        a: 'They come with light preservative oil. Using Lithium grease is recommended for smoother operation.',
      },
    ],
    reviews: [
      {
        user: 'Rahul M.',
        rating: 5,
        comment: 'Perfect fit for my 3D printer axis.',
        date: '2024-03-05',
      },
      {
        user: 'Arjun P.',
        rating: 4,
        comment: 'Smooth operation, much better than cheap generic ones.',
        date: '2024-03-02',
      },
    ],
  ...
  },
  {
    ...
    description:
      'High-quality rubber timing belt with fiberglass reinforcement for precision motion.',
    isActive: true,
