  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="text-center space-y-4">
        ...
        <h2 className="text-3xl font-bold text-slate-900 uppercase tracking-tight">Order Placed Successfully!</h2>
        <p className="text-slate-500 font-medium">
          Thank you for choosing MechHub. Your order <span className="text-[#2F5FA7] font-bold">#{order.orderNumber}</span> has been confirmed.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <span className="block text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Estimated Delivery</span>
                <span className="text-sm font-bold text-slate-800">{format(estimatedDelivery, 'EEE, do MMM yyyy')}</span>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <span className="block text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Items Confirmed</span>
