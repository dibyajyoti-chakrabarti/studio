        ...
        <div className="mt-16 pt-8 border-t border-white/10">
            ...
            <div className="mb-12">
                {user ? (
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="relative">
                            <textarea
                                ...
                                className="w-full min-h-[120px] bg-white/5 border border-white/10 rounded-xl p-4 text-white placeholder:text-zinc-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 resize-y"
                                required
                            />
                    ...
                    <div className="bg-blue-500/5 border border-blue-500/20 rounded-xl p-6 text-center space-y-4">
                        <p className="text-zinc-400">Join the discussion by logging in to your MechHub account.</p>
                        <Button
            ...
            <div className="space-y-6">
                {isLoading ? (
                    ...
                    <p className="text-zinc-500 text-center italic py-8 border border-dashed border-white/10 rounded-xl">
                    ...
                    comments.map((comment) => (
                        <div key={comment.id} className="flex gap-4 group">
                            {/* Avatar */}
                            <div className="w-10 h-10 shrink-0 rounded-full bg-gradient-to-br from-zinc-700 to-zinc-800 flex items-center justify-center text-sm font-bold text-white uppercase shadow-inner border border-white/5">
