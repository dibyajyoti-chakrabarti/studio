    ...
    >
      ...
      {showBendLines && bendsVisible && flatPattern?.bendLines?.map((line, idx) => {
        ...
        return (
          ...
          >
            <div className="bg-slate-900/95 backdrop-blur-xl border border-slate-700 px-4 py-3 rounded-xl shadow-2xl shadow-black/50 whitespace-nowrap animate-in fade-in zoom-in-95 duration-200">
              <div className="flex flex-col gap-1.5">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div
                    className={`flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-[9px] font-black uppercase tracking-tighter ${
                      line.direction === 'UP'
