...
export function ExpertCTA({
  ...
  return (
    <div
      className={`mt-8 p-6 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-[1.5rem] border border-blue-100 shadow-sm flex flex-col md:flex-row items-center justify-between gap-6 ${className}`}
    >
