    ...
    <div className="w-80 bg-white border-r border-slate-200 flex flex-col h-full animate-in slide-in-from-left duration-700">
      ...
      <div className="p-8 border-b border-slate-100">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h2 className="text-sm font-bold tracking-tight text-slate-900 uppercase">MechHub Studio</h2>
        </div>
        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Part Configuration Engine</p>
      </div>
            ...
            return (
              <div key={step.id} className="relative">
                ...
                <div className={cn(
                  ...
                  isActive ? "bg-blue-50/50 shadow-sm border border-blue-100/50" : "opacity-70 hover:opacity-100"
                )}>
                  ...
                  <div className="pt-1">
                    ...
                    <p className={cn(
                      ...
                      isCompleted ? "text-emerald-500" : isActive ? "text-slate-600" : "text-slate-300"
                    )}>
