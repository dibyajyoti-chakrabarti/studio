...
export const LaserArrow: React.FC<LaserArrowProps> = ({
    ...
    return (
        <div className={`relative flex items-center justify-center ${rotationMap[direction]} ${className}`} style={{ width: size, height: size }}>
            <svg
                viewBox="0 0 24 24"
                fill="none"
        ...
        .animate-laser-glow {
          animation: laser-stroke 3s cubic-bezier(.71,.18,.39,.88) infinite;
        }
