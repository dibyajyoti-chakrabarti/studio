  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-2">
        ...
        <Badge variant="outline" className="px-3 py-1 border-slate-200 text-slate-500">{rfqs.length} RFQs</Badge>
      </div>
          ...
          <TableBody>
            {isLoading ? (
              ...
              <TableRow key={rfq.id} className="border-b border-slate-100">
                ...
                <TableCell>
                  <Button size="icon" variant="ghost" className="w-8 h-8" onClick={() => onViewDetails(rfq)}>
