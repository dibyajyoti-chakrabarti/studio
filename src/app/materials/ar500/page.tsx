    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[600px] bg-[#2F5FA7] flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <Image src={AR500_DATA.bgImg} alt="Steel Texture" fill className="object-cover opacity-5 mix-blend-overlay grayscale brightness-150" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-12">
            ...
            <div className="lg:col-span-6">
              <div className="flex items-center gap-2.5 mb-8">
                ...
                <span className="text-[10px] font-black text-blue-100 uppercase tracking-[0.4em]">Extreme Abrasion Resistance</span>
              </div>
              ...
              <div className="flex gap-3 mb-12">
                ...
                <div className="bg-white/10 border border-white/20 rounded-2xl px-6 py-5 backdrop-blur-md hover:bg-white/15 transition-colors group min-w-[140px]">
                  <div className="text-2xl font-black text-white mb-0.5">{AR500_DATA.thicknessRange}</div>
                  <div className="text-[9px] font-black text-blue-100 uppercase tracking-[0.1em] opacity-80">{AR500_DATA.thicknessCount}</div>
                </div>
                {/* Stat Box 2 */}
                <div className="bg-white/10 border border-white/20 rounded-2xl px-6 py-5 backdrop-blur-md hover:bg-white/15 transition-colors group min-w-[140px]">
                  <div className="text-2xl font-black text-white mb-0.5">{AR500_DATA.productionTime}</div>
            ...
            <div className="bg-white border border-slate-200 rounded-[24px] p-8 lg:p-10 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="space-y-3 mb-10">
                {thicknesses.map((t, idx) => (
                  <div key={idx} className="bg-slate-50 border border-slate-100 rounded-xl p-4 flex items-center justify-between group hover:bg-white hover:border-[#2F5FA7]/20 transition-all cursor-default">
                    <div className="flex flex-col">
                      <span className="text-sm font-black text-slate-900 group-hover:text-[#2F5FA7] transition-colors">{t.inch}</span>
                      <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">{t.mm}</span>
                    </div>
              ...
              <Link href="#specifications" className="inline-flex items-center text-[10px] font-black text-[#2F5FA7] hover:text-[#1e40af] uppercase tracking-widest group border-b border-[#2F5FA7]/20 pb-1">
      ...
      <section id="specifications" className="py-24 bg-slate-50/50 relative">
        ...
        <div className="container mx-auto px-6">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 text-center mb-12 uppercase tracking-tight">
            AR500 <span className="text-[#2F5FA7]">sheet metal material</span> details and specifications
          </h2>
          ...
          <div className="max-w-5xl mx-auto flex flex-col lg:flex-row gap-8 items-stretch">
            ...
            <div className="w-full lg:w-48 flex flex-col gap-2">
              ...
              <div className="space-y-2">
                {thicknesses.map((t, idx) => (
                  ...
                  >
                    <span className={`text-xs font-black transition-colors ${selectedThicknessIndex === idx ? 'text-[#2F5FA7]' : 'text-slate-500 group-hover:text-slate-900'}`}>
                      {unit === 'inch' ? t.inch : t.mm}
                    </span>
                    <div className={`h-2.5 rounded-full transition-all duration-500 ${selectedThicknessIndex === idx ? 'bg-black ' + t.barWidth : 'bg-slate-300 w-6 group-hover:bg-slate-400'}`} />
                  </button>
                ))}
              </div>
            </div>
            ...
            <div className="flex-1 bg-white border border-slate-200 rounded-[32px] p-8 lg:p-14 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden">
              <div className="absolute top-0 right-0 p-8">
                 <div className="text-[10px] font-black text-slate-300 uppercase tracking-[0.2em] rotate-90 origin-right translate-x-4">SPECIFICATIONS</div>
              </div>
              ...
              <div className="text-center mb-10">
                ...
                <div className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mt-2">Material Details & Specifications</div>
              </div>

              <div className="flex justify-center mb-12">
                <div className="relative w-full max-w-sm aspect-video">
                  <Image src={AR500_DATA.heroImg} alt="AR500 Specification" fill className="object-contain drop-shadow-2xl transition-transform duration-700 hover:scale-105" />
                </div>
              </div>
              ...
              <div className="max-w-xl mx-auto space-y-3">
                <div className="flex items-center justify-between p-5 border border-slate-100 rounded-2xl bg-slate-50 shadow-inner group hover:bg-white hover:border-[#2F5FA7]/20 transition-all cursor-pointer">
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-xs font-black text-slate-600 uppercase tracking-widest pl-4">Laser Cutting</span>
                  </div>
              ...
              {[
                ...
                <div key={i} className={`flex items-center justify-between p-6 border-slate-100 ${i % 2 === 0 ? 'md:border-r' : ''} ${i < 6 ? 'border-b' : ''} ${i >= 6 && i < 8 ? 'md:border-b-0 border-b' : ''}`}>
                  ...
                  <div className="flex gap-1.5">
                    {[1, 2, 3, 4, 5].map((dot) => (
                      <div key={dot} className={`w-3.5 h-3.5 rounded-full ${dot <= item.rating ? 'bg-black' : 'bg-slate-200'}`} />
                    ))}
                  </div>
                </div>
              ))}
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col lg:flex-row items-center gap-16 max-w-6xl mx-auto">
            <div className="lg:w-1/3 relative">
              <Image src={AR500_DATA.heroImg} alt="Cog" width={400} height={400} className="object-contain drop-shadow-2xl" />
            </div>
            <div className="lg:w-2/3">
              <h2 className="text-4xl lg:text-5xl font-black text-slate-900 mb-8 uppercase tracking-tight">What is <span className="text-[#2F5FA7]">AR500?</span></h2>
              ...
              <h3 className="text-xl font-black text-slate-900 mb-8 uppercase tracking-tight">What can you make with <span className="text-[#2F5FA7]">AR500 parts?</span></h3>
      ...
      <section className="py-16 bg-white overflow-hidden border-t border-slate-50">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-slate-800 mb-10 tracking-tight">Materials similar to AR500</h2>
          <div className="max-w-[400px] mx-auto">
            <Link href="/materials/ar400" className="group block bg-white border border-slate-100 rounded-[16px] overflow-hidden hover:shadow-lg transition-all">
              <div className="flex items-center h-20">
                <div className="w-20 h-full relative bg-slate-900 flex-shrink-0">
                  <Image src="/ar400_sheet.png" alt="AR400" fill className="object-cover opacity-90 group-hover:scale-110 transition-transform duration-500" />
                </div>
                <div className="flex-1 px-5 flex items-center justify-between">
                  <div>
                    <h3 className="text-xs font-black text-slate-900 uppercase tracking-tight text-left">AR400</h3>
                    <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mt-0.5 text-left">1 thickness: .250"</p>
                  </div>
      ...
      <section id="resources" className="py-24 bg-slate-50/50 relative">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-8 h-8 bg-white rotate-45 border-l border-t border-slate-100 hidden lg:block" />
        <div className="container mx-auto px-6">
          <h2 className="text-3xl md:text-5xl font-black text-slate-900 text-center mb-16 uppercase tracking-tight">AR500 <span className="text-[#2F5FA7]">FAQs</span></h2>
          <div className="max-w-4xl mx-auto space-y-4">
            {[
              { q: "What thicknesses does SendCutSend offer AR500 in?", a: "SendCutSend offers AR500 in five thickness options: .119\", .187\", .250\", .375\", and .500\"." },
              { q: "What are the minimum and maximum sizes for cutting AR500?", a: "The smallest part size available is .25\" x .375\", while the largest part supported is 30\" x 44\". For larger projects, custom quotes are available for sizes up to 30\" x 56\"." },
              { q: "What additional services are available for AR500?", a: "You can add Laser Cutting to your AR500 parts." }
            ].map((faq, i) => (
              <div key={i} className={`bg-[#F9FAFB] rounded-[24px] overflow-hidden transition-all duration-300 ${expandedFaq === i ? 'shadow-sm ring-1 ring-[#2F5FA7]/10' : ''}`}>
                <div onClick={() => setExpandedFaq(expandedFaq === i ? null : i)} className="p-8 md:p-10 flex items-center gap-6 cursor-pointer group">
                  ...
                  <span className={`text-base md:text-lg font-bold transition-colors ${expandedFaq === i ? 'text-slate-900' : 'text-slate-700 group-hover:text-slate-900'}`}>{faq.q}</span>
                </div>
                {expandedFaq === i && (
                  <div className="px-8 md:px-24 pb-12 animate-in fade-in slide-in-from-top-4 duration-500">
                    <p className="text-base text-slate-500 font-medium leading-relaxed whitespace-pre-line max-w-3xl">{faq.a}</p>
                  </div>
                )}
              </div>
            ))}
