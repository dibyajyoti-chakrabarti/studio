        ...
        <div className="min-h-screen bg-[#F8FAFC] text-slate-900 font-sans selection:bg-blue-100 selection:text-[#2F5FA7] relative overflow-hidden">
            ...
            <article className="container mx-auto px-4 max-w-4xl pb-24 pt-20">
                ...
                <div className="space-y-4 mb-12 pt-8 relative z-10">
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold text-slate-900 tracking-tight">Refund Policy</h1>
                ...
                <div className="prose prose-slate max-w-none space-y-12 text-slate-600 relative z-10 p-8 md:p-14 rounded-[2.5rem] bg-white border border-slate-100 shadow-2xl overflow-hidden">
                    ...
                    <section className="p-8 rounded-3xl bg-blue-50/30 border border-blue-100 shadow-sm relative overflow-hidden group">
                        ...
                        <p className="text-sm leading-relaxed font-medium text-slate-700">Custom manufacturing is fundamentally different from off-the-shelf product purchases. Every part is manufactured to your exact specifications. Once production begins, the raw material is irreversibly altered and cannot be returned to stock or resold.</p>
                        <p className="mt-3 text-sm font-bold text-[#2F5FA7]/80 italic">This policy ensures fair protection for buyers during genuine quality failures while respecting the custom nature of fabrication.</p>
                    </section>

                    <section>
                        <h2 className="text-2xl font-bold text-slate-900 mb-6 flex items-center gap-3">
                            <span className="text-[#2F5FA7]/20 font-black text-4xl">01</span> Cancellation Protocol
                        </h2>
                        <ul className="space-y-4 p-0 list-none">
                            <li className="p-4 rounded-xl bg-slate-50 border border-slate-100 flex gap-4 items-start">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm">Full refund if the order has not entered the institutional production pipeline.</p>
                                </div>
                            </li>
                            <li className="p-4 rounded-xl bg-slate-50 border border-slate-100 flex gap-4 items-start">
                                <div className="w-1.5 h-1.5 rounded-full bg-[#2F5FA7] mt-1.5 shrink-0" />
                    ...
                    <section>
                        ...
                        <p className="mb-6 font-medium">If parts do not conform to specifications, tolerances, or material requirements stated in your drawing, you are entitled to a remedy.</p>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-4">
                                <h3 className="text-sm font-black uppercase tracking-widest text-[#2F5FA7]">Eligibility</h3>
                                <ul className="space-y-3 p-0 list-none text-sm">
                                    <li className="flex gap-2"><div className="w-1.5 h-1.5 rounded-full bg-blue-400 mt-1.5 shrink-0" /><span>Report within 7 business days</span></li>
                                    <li className="flex gap-2"><div className="w-1.5 h-1.5 rounded-full bg-blue-400 mt-1.5 shrink-0" /><span>Provide measurement evidence (CMM, Calliper)</span></li>
                                    <li className="flex gap-2"><div className="w-1.5 h-1.5 rounded-full bg-red-400 mt-1.5 shrink-0" /><span>Design-originated errors are not covered</span></li>
                                </ul>
                            </div>
                            <div className="space-y-4">
                                <h3 className="text-sm font-black uppercase tracking-widest text-[#2F5FA7]">Remedy Options</h3>
                                <ul className="space-y-3 p-0 list-none text-sm">
                                    <li className="flex gap-2"><div className="w-1.5 h-1.5 rounded-full bg-[#2F5FA7] mt-1.5 shrink-0" /><span>Re-manufacture at no cost</span></li>
                                    <li className="flex gap-2"><div className="w-1.5 h-1.5 rounded-full bg-[#2F5FA7] mt-1.5 shrink-0" /><span>Partial refund for minor deviations</span></li>
                                    <li className="flex gap-2"><div className="w-1.5 h-1.5 rounded-full bg-[#2F5FA7] mt-1.5 shrink-0" /><span>Full refund for unusable parts</span></li>
                                </ul>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="p-10 rounded-[2rem] bg-slate-50 border border-slate-100 mt-12 relative overflow-hidden group">
                        <h2 className="text-2xl font-bold text-slate-900 mb-6 relative z-10">Liaison & Support</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
                            <div className="space-y-2">
                                <p className="text-sm font-black uppercase tracking-widest text-[#2F5FA7]">Corporate Oversight</p>
