        ...
        <div className="min-h-screen bg-[#020617] text-zinc-300 relative overflow-hidden">
            ...
            <article className="container mx-auto px-4 max-w-3xl pb-24 pt-20">
                <div className="space-y-4 mb-16 pt-8 relative z-10">
                    ...
                    <h1 className="text-4xl md:text-5xl font-bankgothic text-white tracking-tight drop-shadow-sm">Refund Policy</h1>
                ...
                <div className="prose prose-invert max-w-none space-y-10 text-sm leading-relaxed text-zinc-400 relative z-10 p-8 md:p-12 rounded-2xl border border-white/[0.05] bg-[#040f25]/50 backdrop-blur-md shadow-[0_0_40px_rgba(34,211,238,0.05)]">
                    <section className="p-6 rounded-xl border border-amber-500/20 bg-amber-950/20">
                        <h2 className="text-lg font-bankgothic text-amber-400 mb-3">Important Note</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bankgothic text-cyan-50 mb-4 border-b border-white/[0.05] pb-2">1. Cancellation Before Production</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bankgothic text-cyan-50 mb-4 border-b border-white/[0.05] pb-2">2. Non-Conforming Parts (Quality Issues)</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bankgothic text-cyan-50 mb-4 border-b border-white/[0.05] pb-2">3. Delivery Damage</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bankgothic text-cyan-50 mb-4 border-b border-white/[0.05] pb-2">4. Non-Refundable Situations</h2>
                        <ul className="list-disc pl-5 space-y-1.5">
                    ...
                    <section>
                        <h2 className="text-xl font-bankgothic text-cyan-50 mb-4 border-b border-white/[0.05] pb-2">5. Refund Processing</h2>
                        <ul className="list-disc pl-5 space-y-1.5">
                    ...
                    <section>
                        <h2 className="text-xl font-bankgothic text-cyan-50 mb-4 border-b border-white/[0.05] pb-2">6. Dispute Resolution</h2>
                    ...
                    <section className="p-6 rounded-xl border border-cyan-500/20 bg-cyan-950/20 mt-12">
                        <h2 className="text-xl font-bankgothic text-cyan-400 mb-4">Contact</h2>
