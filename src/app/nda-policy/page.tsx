        ...
        <div className="min-h-screen bg-[#F8FAFC] text-slate-900 font-sans selection:bg-blue-100 selection:text-[#2F5FA7] relative overflow-hidden">
            ...
            <article className="container mx-auto px-4 max-w-4xl pb-24 pt-20 relative z-10">
                ...
                <div className="space-y-4 mb-12 pt-8">
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold text-slate-900 tracking-tight">NDA Policy</h1>
                ...
                <div className="prose prose-slate max-w-none space-y-12 text-slate-600 p-8 md:p-14 rounded-[2.5rem] bg-white border border-slate-100 shadow-2xl relative overflow-hidden">
                    ...
                    <section className="p-8 rounded-3xl bg-blue-50/30 border border-blue-100 shadow-sm relative overflow-hidden group">
                        ...
                        <p className="text-sm leading-relaxed font-medium text-slate-700">Every design file uploaded to MechHub is automatically protected by our centralized NDA framework. This eliminates the friction of individual agreements while maintaining institutional-grade confidentiality for every order.</p>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 list-none p-0">
                            {[
                                ...
                                <li key={item} className="p-3 rounded-xl bg-slate-50 border border-slate-100 text-sm font-bold text-slate-700 flex items-center gap-3">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-slate-900 mb-6 flex items-center gap-3">
                            <span className="text-[#2F5FA7]/20 font-black text-4xl">02</span> Mandatory Obligations
                        </h2>
                        <div className="space-y-6">
                            <div className="p-6 rounded-2xl border border-slate-100 bg-slate-50/50">
                                <h3 className="text-sm font-black uppercase tracking-widest text-[#2F5FA7] mb-4">MechHub Operations</h3>
                                <p className="text-sm font-medium leading-relaxed">Institutional commitment to zero-distribution with strict internal role-based access. Data shared with MechMasters is limited to fabrication requirements.</p>
                            </div>
                            <div className="p-6 rounded-2xl border border-slate-100 bg-slate-50/50">
                                <h3 className="text-sm font-black uppercase tracking-widest text-[#2F5FA7] mb-4">MechMaster Network</h3>
                                <p className="text-sm font-medium leading-relaxed">Verified partners are contractually prohibited from copying, photographing, or retaining CAD data. Reverse-manufacturing of designs for external entities is strictly banned.</p>
                            </div>
                        </div>
                    </section>

                    <section className="p-10 rounded-[2rem] bg-slate-50 border border-slate-100 mt-12 relative overflow-hidden group">
                        <h2 className="text-2xl font-bold text-slate-900 mb-6 relative z-10">Institutional Governance</h2>
