    ...
    return (
        <BlogLayout>
            <div className="space-y-12">
                <div className="mb-8">
                    <Link href="/" className="inline-flex items-center gap-2 text-sm font-bold uppercase tracking-widest text-[#64748B] hover:text-[#2F5FA7] transition-colors group">
                ...
                <div className="flex flex-col sm:flex-row gap-4 items-center sticky top-24 z-20 bg-white/90 backdrop-blur-xl p-4 rounded-2xl border border-slate-100 shadow-xl">
                    ...
                    <div className="relative w-full sm:w-auto shrink-0">
                        ...
                        >
                            <option value="" className="bg-white text-[#1E3A66]">All Topics</option>
                            {allTags.map(tag => (
                ...
                {posts.length > 0 ? (
                    ...
                    <div className="py-20 text-center space-y-4">
                        ...
                        <p className="text-[#64748B] font-medium">Try adjusting your search or filters to find what you're looking for.</p>
                        <Button
                            variant="outline"
                ...
                <div className="mt-32 relative rounded-3xl overflow-hidden border border-blue-50 bg-[#1E3A66] p-12 text-center shadow-2xl">
                    <div className="relative z-10 max-w-2xl mx-auto space-y-6">
                        ...
                        <p className="text-blue-100/60 font-medium">Join 5,000+ engineers receiving bi-weekly deep dives into hardware innovation.</p>
                        ...
                        <p className="text-[10px] text-white/40 font-bold uppercase tracking-widest">Zero spam. Only precision content.</p>
                    </div>
                    {/* Subtle glow */}
