        ...
        <div className="min-h-screen bg-[#020617] text-zinc-300 font-sans selection:bg-cyan-500/30 selection:text-cyan-200 relative overflow-hidden">
            ...
            <article className="container mx-auto px-4 max-w-3xl pb-24 pt-20 relative z-10">
                <div className="space-y-4 mb-16 pt-8">
                    ...
                    <h1 className="text-4xl md:text-5xl font-bankgothic text-white tracking-tight drop-shadow-sm">Terms of Service</h1>
                ...
                <div className="prose prose-invert max-w-none space-y-10 text-sm leading-relaxed text-zinc-400 p-8 md:p-12 rounded-3xl border border-white/[0.05] bg-[#040f25]/50 backdrop-blur-md shadow-[0_0_40px_rgba(34,211,238,0.05)]">
                    <section>
                        <h2 className="text-xl font-bankgothic text-cyan-50 mb-4 border-b border-white/[0.05] pb-2">1. Acceptance of Terms</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bankgothic text-cyan-50 mb-4 border-b border-white/[0.05] pb-2">2. Platform Description</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bankgothic text-cyan-50 mb-4 border-b border-white/[0.05] pb-2">3. User Accounts</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bankgothic text-cyan-50 mb-4 border-b border-white/[0.05] pb-2">4. RFQ Submission and Orders</h2>
                        <ul className="list-disc pl-5 space-y-1.5 marker:text-cyan-500">
                    ...
                    <section>
                        <h2 className="text-xl font-bankgothic text-cyan-50 mb-4 border-b border-white/[0.05] pb-2">5. Pricing and Payment</h2>
                        <ul className="list-disc pl-5 space-y-1.5 marker:text-cyan-500">
                    ...
                    <section>
                        <h2 className="text-xl font-bankgothic text-cyan-50 mb-4 border-b border-white/[0.05] pb-2">6. Manufacturing and Delivery</h2>
                        <ul className="list-disc pl-5 space-y-1.5 marker:text-cyan-500">
                    ...
                    <section>
                        <h2 className="text-xl font-bankgothic text-cyan-50 mb-4 border-b border-white/[0.05] pb-2">7. Quality and Acceptance</h2>
                        <ul className="list-disc pl-5 space-y-1.5 marker:text-cyan-500">
                    ...
                    <section>
                        <h2 className="text-xl font-bankgothic text-cyan-50 mb-4 border-b border-white/[0.05] pb-2">8. Intellectual Property</h2>
                        <ul className="list-disc pl-5 space-y-1.5 marker:text-cyan-500">
                    ...
                    <section>
                        <h2 className="text-xl font-bankgothic text-cyan-50 mb-4 border-b border-white/[0.05] pb-2">9. Limitation of Liability</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bankgothic text-cyan-50 mb-4 border-b border-white/[0.05] pb-2">10. Prohibited Conduct</h2>
                        <ul className="list-disc pl-5 space-y-1.5 marker:text-cyan-500">
                    ...
                    <section>
                        <h2 className="text-xl font-bankgothic text-cyan-50 mb-4 border-b border-white/[0.05] pb-2">11. Governing Law and Disputes</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bankgothic text-cyan-50 mb-4 border-b border-white/[0.05] pb-2">12. Modifications</h2>
                    ...
                    <section className="p-6 md:p-8 rounded-2xl border border-cyan-500/20 bg-cyan-950/20 mt-12 relative overflow-hidden group">
                        ...
                        <h2 className="text-xl font-bankgothic text-cyan-400 mb-4 relative z-10">13. Contact</h2>
