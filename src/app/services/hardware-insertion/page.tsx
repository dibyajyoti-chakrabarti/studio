    ...
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 selection:bg-blue-100 selection:text-[#2F5FA7] font-sans overflow-x-hidden">
        ...
        <div className="container mx-auto px-4 md:px-10 lg:px-20 py-10 md:py-16">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 text-center">
            <div className="space-y-1">
              <div className="text-2xl md:text-3xl font-black text-slate-900 tracking-tighter">M2 - M8</div>
              <div className="text-[10px] font-black uppercase tracking-widest text-[#2F5FA7]">Metric Nuts</div>
            </div>
            <div className="space-y-1">
              <div className="text-2xl md:text-3xl font-black text-slate-900 tracking-tighter">#2 - 5/16"</div>
              <div className="text-[10px] font-black uppercase tracking-widest text-[#2F5FA7]">SAE Studs</div>
            </div>
            <div className="space-y-1">
              <div className="text-2xl md:text-3xl font-black text-slate-900 tracking-tighter">6T - 8T</div>
              <div className="text-[10px] font-black uppercase tracking-widest text-[#2F5FA7]">Press Force</div>
            </div>
            <div className="space-y-1">
              <div className="text-2xl md:text-3xl font-black text-slate-900 tracking-tighter">0.8 - 4.8mm</div>
              <div className="text-[10px] font-black uppercase tracking-widest text-[#2F5FA7]">Sheet Thickness</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-10 lg:px-20">
          <div className="text-center max-w-3xl mx-auto mb-20 leading-tight">
            ...
            <p className="text-lg text-slate-600 font-medium">
              We utilize automated Haeger® presses to install self-clinching nuts, studs, and standoffs that become a permanent part of the substrate.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { title: "Self-Clinching Nuts", desc: "Permanent high-strength internal threads (PEM style) for thin sheets where tapping is not feasible.", icon: ShieldCheck, img: "https://images.unsplash.com/photo-1540573133985-87b6da6d54a9?auto=format&fit=crop&q=80", color: "bg-blue-600" },
              { title: "Standoffs & Spacers", desc: "Automated insertion of threaded pillars for PCB mounting and structural parallel plate alignment.", icon: Settings, img: "https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?auto=format&fit=crop&q=80", color: "bg-blue-400" },
              { title: "Threaded Studs", desc: "Flush-mount external threaded fasteners for grounding points and component mounting applications.", icon: Zap, img: "https://images.unsplash.com/photo-1581092160562-40aa08e78837?auto=format&fit=crop&q=80", color: "bg-[#2F5FA7]" },
            ].map((item, index) => (
          ...
          <ExpertCTA 
            description="Looking for specific PEM fastener types, custom standoff heights, or high-density insertion patterns? Our assembly experts can help optimize your hardware BOM."
          />
        </div>
      </section>
            ...
            <div className="space-y-12">
              <div>
                ...
                <p className="text-xl text-slate-400 leading-relaxed font-medium">
                  Proper hole sizing and edge distance are critical to prevent sheet deformation during high-pressure insertion.
                </p>
              </div>

              <div className="space-y-8">
                {[
                  { id: "H1", title: "Hole Tolerance", desc: "Clinching holes must be within +0.08mm / -0.00mm. We recommend laser cutting for perfect fitment.", icon: <ShieldCheck className="w-5 h-5" /> },
                  { id: "H2", title: "Edge Distance", desc: "The center of the hole should be at least 2.5x the hole diameter from any edge to prevent bulging.", icon: <Maximize2 className="w-5 h-5" /> },
                  { id: "H3", title: "Material Hardness", desc: "The substrate must be softer than the fastener. Most Al and CRS grades are perfectly compatible.", icon: <Layers className="w-5 h-5" /> },
                ].map((item) => (
              ...
              <div className="aspect-[4/3] bg-white border-8 border-slate-900 rounded-[3rem] overflow-hidden shadow-2xl relative p-12">
                ...
                <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/60 to-transparent p-10">
                  <div className="bg-white/95 backdrop-blur-md px-6 py-4 rounded-2xl shadow-xl inline-flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-[10px] font-black uppercase tracking-widest text-slate-500">Insertion Check</p>
                      <p className="text-sm font-bold text-slate-900 text-nowrap">Auto-Pressure Calibration Active</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="flex flex-col lg:flex-row gap-20">
            <div className="lg:w-1/3">
              ...
              <p className="text-slate-600 font-medium mb-12">
                Our configurator identifies hole networks for self-clinching hardware and assigns the correct press tools automatically.
              </p>
              <div className="block mt-12">
                <div className="w-full aspect-[4/5] relative rounded-[3rem] overflow-hidden shadow-2xl">
                  <Image src="https://images.unsplash.com/photo-1581092160562-40aa08e78837?auto=format&fit=crop&q=80" alt="Process Visualization" fill className="object-cover" />
              ...
              {[
                {
                  ...
                  description: "Upload your CAD. Our system detects standard PEM® hole sizes and prompts you to select the corresponding hardware (Nuts, Studs, Standoffs)."
                },
                {
                  step: "02",
                  title: "Tagging & Pressure",
                  description: "Indicate which holes receive hardware. Our engine calculates the required insertion force based on material type and thickness."
                },
                {
                  step: "03",
                  title: "Automated Pressing",
                  description: "Once confirmed, the design is queued for our automated Haeger® presses where pressure is strictly controlled for a permanent lock."
                }
              ].map((item, idx) => (
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 text-center">
          <p className="text-sm font-black text-[#2F5FA7] uppercase tracking-[0.3em] mb-4">Mechanical Integration</p>
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="font-bold text-slate-700 uppercase leading-none">PEM® Grade Standards</span>
            </div>
            <div className="flex items-center gap-3">
              <ShieldCheck className="w-6 h-6 text-green-500" />
              <span className="font-bold text-slate-700 uppercase leading-none">Industrial Resilience</span>
            </div>
          </div>
        </div>
      </section>
