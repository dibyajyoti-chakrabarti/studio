    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#020617] text-zinc-300 relative overflow-hidden">
        ...
        <div className="mt-8 flex gap-2 relative z-10">
          ...
          <div className="w-3 h-3 bg-cyan-500 rounded-full animate-bounce shadow-[0_0_10px_rgba(34,211,238,0.5)]" style={{ animationDelay: '0.2s' }} />
          <div className="w-3 h-3 bg-cyan-500 rounded-full animate-bounce shadow-[0_0_10px_rgba(34,211,238,0.5)]" style={{ animationDelay: '0.4s' }} />
        </div>
      </div>
    );
  }
      ...
      <div className="container mx-auto px-4 max-w-6xl relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-6">
          ...
          <div className="bg-gradient-to-r from-cyan-950/20 to-[#040f25]/40 border border-cyan-500/20 backdrop-blur-sm p-4 rounded-xl flex items-center gap-3">
            ...
            <p className="text-sm font-light">We recommend selecting <b className="text-white">3-5 vendors</b> for optimal bidding results.</p>
          </div>
        </div>
              ...
              <Card className="overflow-hidden border border-white/[0.05] bg-[#040f25]/30 backdrop-blur-md hover:border-cyan-500/30 hover:bg-cyan-950/20 transition-all duration-300 h-full group-hover:shadow-[0_0_30px_rgba(34,211,238,0.1)]">
                <div className="relative h-48 bg-[#020617]/50 flex items-center justify-center border-b border-white/[0.05]">
                  ...
                  <div className="absolute top-3 right-3 flex flex-col items-end gap-2">
                    <Checkbox checked={selectedVendors.includes(vendor.id)} className="w-6 h-6 border-white/20 bg-black/50 backdrop-blur-sm data-[state=checked]:bg-cyan-500 data-[state=checked]:border-cyan-500 text-white" />
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex items-center gap-4 text-zinc-500 text-[10px] font-bold uppercase tracking-widest mb-4 font-consolas">
                    <div className="flex items-center gap-1.5"><MapPin className="w-3 h-3 text-cyan-500" /> {vendor.location || 'Location Pending'}</div>
                    <div className="flex items-center gap-1.5"><Clock className="w-3 h-3 text-cyan-500" /> {vendor.experienceYears || '0'}+ Yrs Exp</div>
                  </div>
        ...
        <div className="fixed bottom-0 left-0 right-0 p-6 bg-[#020617]/80 backdrop-blur-md border-t border-white/[0.05] flex items-center justify-center z-50">
          <div className="container max-w-6xl w-full flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="text-sm font-medium flex items-center gap-3">
              <Badge variant="secondary" className="text-lg px-4 py-1 bg-cyan-950 border border-cyan-500/30 text-cyan-400 rounded-full font-consolas shadow-[0_0_15px_rgba(34,211,238,0.2)]">{selectedVendors.length}</Badge>
              <span className="text-zinc-400 font-bold uppercase tracking-widest text-[11px] font-consolas">Vendors Selected for Bidding</span>
            </div>
            <Button
              size="lg"
